 ...
 <li><a  class="navi" href="home.php">
    ...
    <section class="main">
      ...
      <h1>   <div class="detail_box">
          ...
          Personality development learning involves a systematic approach to improving various aspects of an individual's character, behavior, and mindset. It aims to enhance one's personal and social effectiveness, leading to a more fulfilling and successful life
          Personality development is a lifelong process that helps people develop their potential, set goals, and live a more fulfilling life. It focuses on adding new skills and ways of achieving goals in life.
        </br><h4>let's lean with us </h4>  
        </div>
    </div>
      <div class="col-md-6">
